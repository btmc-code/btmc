...
import (
	...
	"github.com/btmc-code/com/bech32"
)
...
//
// The btminer network the address is associated with is extracted if possible.
...
// with the passed btminer network.
// Part of the Address interface.
