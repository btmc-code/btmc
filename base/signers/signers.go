...
var (
	...
	// BTMCCoinType coin type field 0x00000099 little-endian mode.
	BTMC.CoinType = []byte{0x99, 0x00, 0x00, 0x00}
)
...
func getBip0044Path(accountIndex uint64, change bool, addrIndex uint64) [][]byte {
	...
	path = append(path, BTMCCoinType[:])  //coin type
