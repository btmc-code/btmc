...
// Btminer-specific header fields
const (
	HeaderBlockchainID = "Blockchain-ID"
	HeaderCoreID       = "Btminer-Core-ID"
...
// A Client is a Btminer RPC client. It performs RPCs over HTTP using JSON
...
func (c Client) userAgent() string {
	return fmt.Sprintf("Btminer; process=%s; buildtag=%s; blockchainID=%s",
