...
func DefaultDataDir() string {
	...
	case "darwin":
		...
		oldPath := filepath.Join(home, "Library", "Btminer")
		newPath := filepath.Join(home, "Library", "Application Support", "Btminer")
		...
		return newPath
	case "windows":
		return filepath.Join(home, "AppData", "Roaming", "Btminer")
	default:
		return filepath.Join(home, ".btminer")
	}
}
