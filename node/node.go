...
import (
	...
	"github.com/bmtc-code/rpc"
	"github.com/btmc-code/base/pseudohsm"
	"github.com/btmc-code/base/txfeed"
	cfg "github.com/btmc-code/conf"
	"github.com/btmc-code/database/leveldb"
	"github.com/btmc-code/mining/cpuminer"
	"github.com/btmc-code/mining/miningpool"
	"github.com/btmc-code/mining/tensority"
)
...
func NewNode(config *cfg.Config) *Node {
	...
	if profileHost != "" {
		// Profiling btminerd programs.see (https://blog.golang.org/profiling-go-programs)
